		...
		<>
			<div id='top-home' className='grid'>
				...
				<div className='hidden sm:block'>
					...
					<span className='text-white flex justify-center text-5xl opacity-20 animate-pulse'>
						<AiOutlineArrowDown />
					</span>
				</div>
				<div className=''>
					<div className='sm:hidden text-center'>
						<span className='text-red-500 text-3xl opacity-90 tracking-widest animate-pulse'>
							{' '}
							projects
						</span>
					</div>
